...
<body class="is-preload">
	...
	<div id="wrapper">
		...
		<nav id="nav">
			<ul>
				<li><a href="reportBoardList.do" class="active"><spring:message code="report.boardlist" /></a></li>
		...
		<div id="main">
			...
			<section id="intro" class="main">
				<div class="spotlight">
					<div class="content">
						<header class="major">
							<h3><spring:message code="report.boardlist" /></h3>
						</header>
							...
							<table>
								<thead>
									<tr>
										...
										<th><spring:message code="report.title" /></th>
										<th><spring:message code="report.writer" />(<spring:message code="report.mid" />)</th>
									</tr>
								</thead>
								<tbody>
