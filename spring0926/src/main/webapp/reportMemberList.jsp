	...
	<div id="wrapper">
		...
		<nav id="nav">
			<ul>
				...
				<li><a href="reportReplyList.do"><spring:message code="report.replylist" /></a></li>
				<li><a href="reportMemberList.do" class="active"><spring:message code="report.memberlist" /></a></li>
			</ul>
		</nav>
		...
		<div id="main">
			...
			<section id="intro" class="main">
				<div class="spotlight">
					<div class="content">
						<header class="major">
							<h3><spring:message code="report.memberlist" /></h3>
						</header>
							<table>
								<thead>
									<tr>
										<th><spring:message code="report.mid" /></th>
										<th><spring:message code="report.name" /></th>
										<th><spring:message code="report.penalty" /></th>
										<th>&nbsp;</th>
									</tr>
								</thead>
								<tbody>
									<c:forEach var="v" items="${datas}">
										<tr>
											...
											<td>${v.name}</td>
											<td>${v.penalty}</td>
											<td><a href="deleteMember.do?mid=${v.mid}"><spring:message code="report.expel" /></a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
