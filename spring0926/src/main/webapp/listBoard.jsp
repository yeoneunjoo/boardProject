			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<!-- <nav id="nav">
							<ul>
								<li><a href="list.do" class="active">내가 작성한 글 목록</a></li>
								<li><a href="listReply.do">내가 작성한 댓글 목록</a></li>
							</ul>
						</nav> -->
						<!-- Introduction -->
							<section id="intro" class="main">
								<div class="spotlight">
									<div class="content">
										<header class="major">
											<h2><spring:message code="listBoard.list" />&nbsp;&nbsp;:D</h2>
										</header>
										...
										<div class="table-wrapper">
											<table>
												...
												<tfoot>
													<tr>
														<td colspan="2"></td>
														<td colspan="2"><a href="mypage.do"><spring:message code="mypage.mypage" /></a>
